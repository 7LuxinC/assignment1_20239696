...
class PrivateHomeaNGHA8F4TEear0NzybbrMtw extends dime.DIMEComponent implements OnInit, OnDestroy, AfterViewInit {
  	...
  	// branch LibrarianMS as info.scce.dime.gui.editor.graphiti.api.CButton@2d11a03 (id: _ZF1EwU1xEeyjn6oaCYeN5A) in info.scce.dime.gui.editor.graphiti.api.CGUI@3b65aee7 (id: _NGHA8F4TEear0NzybbrMtw)
  	@Output('actionlibrarianmsevent') Stream<Map<String,dynamic>> get evt_actionlibrarianmsevent => actionlibrarianmsevent.stream;
  	StreamController<Map<String,dynamic>> actionlibrarianmsevent = new StreamController();
	...
	void restartComponent() {
		...
		// branch LibrarianMS declaration
		if(this.actionlibrarianmsevent!=null) {
			  			this.actionlibrarianmsevent = new StreamController<Map<String,dynamic>>();  				
		}
	...
	void ngAfterViewInit() {
		...
		js.context.callMethod("enableTooltip",[]);
  		...
  		/// callback, if the button LibrarianMS is clicked
  			void actionlibrarianmseventaZF1EwU1xEeyjn6oaCYeN5AEventTrigger()
  		
  		{
  			Map<String,dynamic> data = new Map();
  			this.actionlibrarianmsevent.add(data);
  		}
