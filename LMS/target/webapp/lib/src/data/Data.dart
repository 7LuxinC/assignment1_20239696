...
class DataCastUtil {
	...
	static LMS castToLMS(core.Object o) => o as LMS;
	static DIMEList<LMS> castToListLMS(DIMEList<core.Object> os) => new DIMEList.from(os.cast<LMS>());
	static DIMEList<LMS> newListLMS() => new DIMEList<LMS>();
	
	static Librarian castToLibrarian(core.Object o) => o as Librarian;
	static DIMEList<Librarian> castToListLibrarian(DIMEList<core.Object> os) => new DIMEList.from(os.cast<Librarian>());
	static DIMEList<Librarian> newListLibrarian() => new DIMEList<Librarian>();
}
class ConcreteUser extends BaseModel
{
	...
	core.bool _lMSHasBeenSet = false;
	core.bool lMSHasBeenChanged() => _lMSHasBeenSet||(_lMS==null?false:_lMS.hasChanged()) ;
	LMS _lMS;
	...
	void $$setProperty(core.String prop, core.dynamic value) {
	  ...
	  case 'lMS': this.lMS = value; return;
	...
	ConcreteUser({core.Map<core.String,core.dynamic> cache, jsog}) {
		...
		// from jsog
			...
			if (jsog.containsKey("dywaSwitchedTo")) {
				...
				if(jsogObj != null) {
					ConcreteUser valueaxENRUU6hEeyh2IUlWbuNpA;
					...
					if (cache.containsKey(jsogId)) {
						valueaxENRUU6hEeyh2IUlWbuNpA = cache[jsogId];
					}
					else {
						if (jsogObj != null) {
							if (jsogObj['dywaRuntimeType'] == "de.ls5.dywa.generated.rest.types.ConcreteUserImpl") {
								valueaxENRUU6hEeyh2IUlWbuNpA = new ConcreteUser(cache: cache, jsog: jsogObj);
							}
							else {
								valueaxENRUU6hEeyh2IUlWbuNpA = new ConcreteUser(cache: cache,jsog: jsogObj);
							}
					...
					this._dywaSwitchedTo = valueaxENRUU6hEeyh2IUlWbuNpA;
				}
			}
			
			
			_dywaSwitchedToHasBeenSet = false;
			if (jsog.containsKey("lMS")) {
				core.Map<core.String,core.dynamic> jsogObj = jsog["lMS"];
				if(jsogObj != null) {
					LMS valueazTDRgU1vEeyjn6oaCYeN5A;
					...
					if (cache.containsKey(jsogId)) {
						valueazTDRgU1vEeyjn6oaCYeN5A = cache[jsogId];
					}
					else {
						if (jsogObj != null) {
							if (jsogObj['dywaRuntimeType'] == "de.ls5.dywa.generated.rest.types.LMSImpl") {
								valueazTDRgU1vEeyjn6oaCYeN5A = new LMS(cache: cache, jsog: jsogObj);
							}
							else {
								valueazTDRgU1vEeyjn6oaCYeN5A = new LMS(cache: cache,jsog: jsogObj);
							}
	...
	core.Map<core.String,core.dynamic> toJSOG(core.Map<core.Object,core.dynamic> objects) {
		...
		if(objects.containsKey(this)) {
			...
			if(( lMSHasBeenChanged() && !jsonObj.containsKey('lMS')) && !objects.containsKey(this._lMS)) {
			if(this._lMS != null) {
				jsonObj["lMS"] = this._lMS.toJSOG(objects);
			}
			else {
				jsonObj["lMS"] = null;
			}
		...
		if(( lMSHasBeenChanged() && !jsonObj.containsKey('lMS')) && !objects.containsKey(this._lMS) || this.dywa_id == 0) {
		if(this._lMS != null) {
			jsonObj["lMS"] = this._lMS.toJSOG(objects);
		}
		else {
	...
	void set lMS (LMS value)
	{
		this._lMSHasBeenSet = true;
		this._lMS = value;
	}
	...
	LMS get lMS
	{
		...
		void setValuelMS(LMS value)
		{
			this.lMS = value;
		}
		
		void lMSsetValue(LMS value)
		{
			this.lMS = value;
		}
...
class LMS extends BaseModel
{
	...
	core.bool _librarianHasBeenSet = false;
	core.bool librarianHasBeenChanged() => _librarianHasBeenSet||(_librarian==null?false:_librarian.hasChanged()) ;
	Librarian _librarian;
	
	static LMS fromId(core.int id) {
		var m = new LMS();
		m.dywa_id = id;
		return m;
	}
	...
	void $$setProperty(core.String prop, core.dynamic value) {
	  switch (prop) {
	  case 'concreteUser': this.concreteUser = value; return;
	  case 'librarian': this.librarian = value; return;
	    default: throw NoSuchPropertyException(prop);
	  }
	}
	...
	LMS({core.Map<core.String,core.dynamic> cache, jsog}) {
		if (cache == null) {
			cache = new core.Map();
		}
		...
		// from jsog
			...
			if (jsog.containsKey("concreteUser")) {
				...
				if(jsogObj != null) {
					ConcreteUser valueazR1JgE1vEeyjn6oaCYeN5A;
					...
					if (cache.containsKey(jsogId)) {
						valueazR1JgE1vEeyjn6oaCYeN5A = cache[jsogId];
					}
					else {
						if (jsogObj != null) {
							if (jsogObj['dywaRuntimeType'] == "de.ls5.dywa.generated.rest.types.ConcreteUserImpl") {
								valueazR1JgE1vEeyjn6oaCYeN5A = new ConcreteUser(cache: cache, jsog: jsogObj);
							}
							else {
								valueazR1JgE1vEeyjn6oaCYeN5A = new ConcreteUser(cache: cache,jsog: jsogObj);
							}
					...
					this._concreteUser = valueazR1JgE1vEeyjn6oaCYeN5A;
				}
			}
			
			
			_concreteUserHasBeenSet = false;
			if (jsog.containsKey("librarian")) {
				core.Map<core.String,core.dynamic> jsogObj = jsog["librarian"];
				if(jsogObj != null) {
					Librarian valueayPKyoE1vEeyjn6oaCYeN5A;
					...
					if (cache.containsKey(jsogId)) {
						valueayPKyoE1vEeyjn6oaCYeN5A = cache[jsogId];
					}
					else {
						if (jsogObj != null) {
							if (jsogObj['dywaRuntimeType'] == "de.ls5.dywa.generated.rest.types.LibrarianImpl") {
								valueayPKyoE1vEeyjn6oaCYeN5A = new Librarian(cache: cache, jsog: jsogObj);
							}
							else {
								valueayPKyoE1vEeyjn6oaCYeN5A = new Librarian(cache: cache,jsog: jsogObj);
							}
					...
					this._librarian = valueayPKyoE1vEeyjn6oaCYeN5A;
				}
			}
			
			
			_librarianHasBeenSet = false;
		}
	}
	
	void concreteUserHasBeenSetted() { _concreteUserHasBeenSet=true; }
	void librarianHasBeenSetted() { _librarianHasBeenSet=true; }
	
	core.bool hasChanged() {
		return 		_concreteUserHasBeenSet || 
					_librarianHasBeenSet
			;
	}
	...
	core.Map<core.String,core.dynamic> toJSOG(core.Map<core.Object,core.dynamic> objects) {
		...
		if(objects.containsKey(this)) {
			jsogId = objects[this]['id'];
			jsonObj = objects[this]['value'];
			if(( librarianHasBeenChanged() && !jsonObj.containsKey('librarian')) && !objects.containsKey(this._librarian)) {
			if(this._librarian != null) {
				jsonObj["librarian"] = this._librarian.toJSOG(objects);
			}
			else {
		...
		jsonObj['@id'] = jsogId.toString();
		jsonObj['dywaRuntimeType'] = "de.ls5.dywa.generated.rest.types.LMSImpl";
		...
		if(( librarianHasBeenChanged() && !jsonObj.containsKey('librarian')) && !objects.containsKey(this._librarian) || this.dywa_id == 0) {
		if(this._librarian != null) {
			jsonObj["librarian"] = this._librarian.toJSOG(objects);
		}
		else {
	...
	static LMS fromJSOG({core.Map<core.String,core.dynamic> cache, jsog}) {
		if(jsog.containsKey('@ref')) {
			assert (cache.containsKey(jsog['@ref']));
			return cache[jsog['@ref']];
		}
		if(jsog['dywaRuntimeType'] == 'de.ls5.dywa.generated.rest.types.LMSImpl') {
			return new LMS(cache:cache,jsog:jsog);
		}
		return new LMS(cache:cache,jsog:jsog);
	}
	
	void set librarian (Librarian value)
	{
		this._librarianHasBeenSet = true;
		this._librarian = value;
	}
	
	Librarian get librarian
	{
		return this._librarian;
	}
	
		Librarian initOnDemandlibrarian()
		{
			if(this._librarian == null) {
		...
		void setValuelibrarian(Librarian value)
		{
			this.librarian = value;
		}
		
		void librariansetValue(Librarian value)
		{
			this.librarian = value;
		}
...
class Librarian extends BaseModel
{
	core.bool _firstnameHasBeenSet = false;
	core.bool firstnameHasBeenChanged() => _firstnameHasBeenSet;
	core.String _firstname;
	core.bool _idHasBeenSet = false;
	core.bool idHasBeenChanged() => _idHasBeenSet;
	core.int _id;
	core.bool _lastnameHasBeenSet = false;
	core.bool lastnameHasBeenChanged() => _lastnameHasBeenSet;
	core.String _lastname;
	core.bool _positionHasBeenSet = false;
	core.bool positionHasBeenChanged() => _positionHasBeenSet;
	core.String _position;
	core.bool _sectionHasBeenSet = false;
	core.bool sectionHasBeenChanged() => _sectionHasBeenSet;
	core.String _section;
	
	static Librarian fromId(core.int id) {
		var m = new Librarian();
		m.dywa_id = id;
		return m;
	}
	...
	void $$setProperty(core.String prop, core.dynamic value) {
	  ...
	  case 'lastname': this.lastname = value; return;
	  case 'position': this.position = value; return;
	  case 'section': this.section = value; return;
	    default: throw NoSuchPropertyException(prop);
	  }
	}
	...
	Librarian({core.Map<core.String,core.dynamic> cache, jsog}) {
		if (cache == null) {
			cache = new core.Map();
		}
		...
		// from jsog
			...
			if (jsog.containsKey("firstname")) {
				core.String jsogObj = jsog["firstname"];
				if(jsogObj != null) {
					core.String valueahz5TAU1vEeyjn6oaCYeN5A;
					
					if(jsogObj!=null){
					valueahz5TAU1vEeyjn6oaCYeN5A = jsogObj.toString();
					}
					this._firstname = valueahz5TAU1vEeyjn6oaCYeN5A;
				}
				else {
					this._firstname = null;
				}
			...
			_firstnameHasBeenSet = false;
			if (jsog.containsKey("id")) {
				core.int jsogObj = jsog["id"];
				if(jsogObj != null) {
					core.int valueaiFnVIE1vEeyjn6oaCYeN5A;
					
					if(jsogObj!=null){
					valueaiFnVIE1vEeyjn6oaCYeN5A = core.int.parse(jsogObj.toString());
					}
					this._id = valueaiFnVIE1vEeyjn6oaCYeN5A;
				}
				else {
					this._id = 0;
				}
			...
			if (jsog.containsKey("lastname")) {
				core.String jsogObj = jsog["lastname"];
				if(jsogObj != null) {
					core.String valueahd_7gU1vEeyjn6oaCYeN5A;
					
					if(jsogObj!=null){
					valueahd_7gU1vEeyjn6oaCYeN5A = jsogObj.toString();
					}
					this._lastname = valueahd_7gU1vEeyjn6oaCYeN5A;
				}
				else {
					this._lastname = null;
				}
			...
			_lastnameHasBeenSet = false;
			if (jsog.containsKey("position")) {
				core.String jsogObj = jsog["position"];
				if(jsogObj != null) {
					core.String valueajOWe0U1vEeyjn6oaCYeN5A;
					
					if(jsogObj!=null){
					valueajOWe0U1vEeyjn6oaCYeN5A = jsogObj.toString();
					}
					this._position = valueajOWe0U1vEeyjn6oaCYeN5A;
				}
				else {
					this._position = null;
				}
			...
			if (jsog.containsKey("section")) {
				core.String jsogObj = jsog["section"];
				if(jsogObj != null) {
					core.String valueai1UTwU1vEeyjn6oaCYeN5A;
					
					if(jsogObj!=null){
					valueai1UTwU1vEeyjn6oaCYeN5A = jsogObj.toString();
					}
					this._section = valueai1UTwU1vEeyjn6oaCYeN5A;
				}
				else {
					this._section = null;
				}
			...
			_sectionHasBeenSet = false;
		}
	}
	
	void firstnameHasBeenSetted() { _firstnameHasBeenSet=true; }
	void idHasBeenSetted() { _idHasBeenSet=true; }
	void lastnameHasBeenSetted() { _lastnameHasBeenSet=true; }
	void positionHasBeenSetted() { _positionHasBeenSet=true; }
	void sectionHasBeenSetted() { _sectionHasBeenSet=true; }
	
	core.bool hasChanged() {
		return 		_firstnameHasBeenSet || 
					_idHasBeenSet || 
					_lastnameHasBeenSet || 
					_positionHasBeenSet || 
					_sectionHasBeenSet
	...
	core.Map<core.String,core.dynamic> toJSOG(core.Map<core.Object,core.dynamic> objects) {
		...
		if(objects.containsKey(this)) {
			...
			if(( idHasBeenChanged() && !jsonObj.containsKey('id')) && !objects.containsKey(this._id)) {
			jsonObj["id"] = this._id;
			}
			if(( sectionHasBeenChanged() && !jsonObj.containsKey('section')) && !objects.containsKey(this._section)) {
			jsonObj["section"] = this._section;
			}
			if(( positionHasBeenChanged() && !jsonObj.containsKey('position')) && !objects.containsKey(this._position)) {
			jsonObj["position"] = this._position;
			}
			return { 
				'@ref': jsogId.toString()
			};
		...
		jsonObj['@id'] = jsogId.toString();
		jsonObj['dywaRuntimeType'] = "de.ls5.dywa.generated.rest.types.LibrarianImpl";
		...
		if(( idHasBeenChanged() && !jsonObj.containsKey('id')) && !objects.containsKey(this._id) || this.dywa_id == 0) {
		jsonObj["id"] = this._id;
		}
		if(( sectionHasBeenChanged() && !jsonObj.containsKey('section')) && !objects.containsKey(this._section) || this.dywa_id == 0) {
		jsonObj["section"] = this._section;
		}
		if(( positionHasBeenChanged() && !jsonObj.containsKey('position')) && !objects.containsKey(this._position) || this.dywa_id == 0) {
		jsonObj["position"] = this._position;
		}
		return jsonObj;
	}
	...
	static Librarian fromJSOG({core.Map<core.String,core.dynamic> cache, jsog}) {
		if(jsog.containsKey('@ref')) {
			assert (cache.containsKey(jsog['@ref']));
			return cache[jsog['@ref']];
		}
		if(jsog['dywaRuntimeType'] == 'de.ls5.dywa.generated.rest.types.LibrarianImpl') {
			return new Librarian(cache:cache,jsog:jsog);
		}
		return new Librarian(cache:cache,jsog:jsog);
	}
	...
	core.int get id
	{
		...
		core.int initOnDemandid()
		{
			return this.id;
		}
		
		void setValueid(core.int value)
		{
			this.id = value;
		}
		
		void idsetValue(core.int value)
		{
			this.id = value;
		}
		
	
	void set section (core.String value)
	{
		this._sectionHasBeenSet = true;
		this._section = value;
	}
	
	core.String get section
	{
		return this._section;
	}
	
		core.String initOnDemandsection()
		{
			return this.section;
		}
		
		void setValuesection(core.String value)
		{
			this.section = value;
		}
		
		void sectionsetValue(core.String value)
		{
			this.section = value;
		}
		
	
	void set position (core.String value)
	{
		this._positionHasBeenSet = true;
		this._position = value;
	}
	
	core.String get position
	{
		return this._position;
	}
	
		core.String initOnDemandposition()
		{
			return this.position;
		}
		
		void setValueposition(core.String value)
		{
			this.position = value;
		}
		
		void positionsetValue(core.String value)
		{
			this.position = value;
		}
