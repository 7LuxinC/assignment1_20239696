...
public class LMSSearch implements LMS {
	...
	static {
		java.lang.Class<?> targetClass = LMSImpl.class;
	...
	public LMSSearch(java.lang.String name) {
	...
	public de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Librarian getlibrarian() {
		return (de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Librarian) this.attributeMap.get(dywaIdToJpqlAttr.get(13L));
	}
	public void setlibrarian
	(de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Librarian object) {
			
				if (! (object instanceof de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Librarian)) {
	...
	public de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser getconcreteUser() {
		return (de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser) this.attributeMap.get(dywaIdToJpqlAttr.get(14L));
	}
	public void setconcreteUser
