...
public class ConcreteUserImpl implements ConcreteUser {
	...
	@org.hibernate.annotations.Cascade(org.hibernate.annotations.CascadeType.PERSIST)
	@javax.persistence.JoinColumn(name = "a_LMS__ztdrgu1veeyjn6o")
	@org.hibernate.annotations.Any(metaColumn=@javax.persistence.Column(name="m_LMS_Type__ztdrgu1veeyjn6o"))
	@org.hibernate.annotations.AnyMetaDef(
		idType="long", metaType="string",
		metaValues={
			@org.hibernate.annotations.MetaValue(targetEntity=de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMSImpl.class, value="_yh4gsu1veeyjn6o")
		}
	)
	private de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS lMS;
	
	@de.ls5.dywa.annotations.IdRef(id = 6L)
	@org.hibernate.annotations.Cascade(org.hibernate.annotations.CascadeType.PERSIST)
	@javax.persistence.JoinColumn(name = "a_DywaSwitchedTo__xenruu6heeyh2iu")
	@org.hibernate.annotations.Any(metaColumn=@javax.persistence.Column(name="m_DywaSwitchedTo_Type__xenruu6heeyh2iu"))
	@org.hibernate.annotations.AnyMetaDef(
		idType="long", metaType="string",
		metaValues={
	...
	@java.lang.Override
	public de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS getlMS() {
		return this.lMS;
	}
	
	@java.lang.Override
	public void setlMS(de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS object) {
		if (!this.bidirectionalDirtyFlag) {
			this.bidirectionalDirtyFlag = true;
			final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS current = this.getlMS();
			final ConcreteUser _instance =
			this;
			if(current != null){
				current.setconcreteUser(null);
			}
			if(object!=null){
				object.setconcreteUser(_instance);
			}
			this.lMS = object;
			this.bidirectionalDirtyFlag = false;
		}
