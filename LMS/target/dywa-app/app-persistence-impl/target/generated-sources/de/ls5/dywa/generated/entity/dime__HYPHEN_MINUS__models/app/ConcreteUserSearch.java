...
public class ConcreteUserSearch implements ConcreteUser {
	...
	public de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.BaseUser getbaseUser() {
		return (de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.BaseUser) this.attributeMap.get(dywaIdToJpqlAttr.get(4L));
	}
	...
	(de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.BaseUser object) {
			...
			this.attributeMap.put(dywaIdToJpqlAttr.get(4L), object);
	}
	@java.lang.Override
	public de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS getlMS() {
		return (de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS) this.attributeMap.get(dywaIdToJpqlAttr.get(5L));
	}
	public void setlMS
	(de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS object) {
			
				if (! (object instanceof de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS)) {
							throw new java.lang.RuntimeException("Wrong type");
				}
