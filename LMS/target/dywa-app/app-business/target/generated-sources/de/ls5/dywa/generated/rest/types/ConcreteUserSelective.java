...
public class ConcreteUserSelective {
	...
	public static void copy(
		...
		final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS
		 source = effectiveFrom.getlMS();
		if (source != null) {
			// original selective: LMSSelective
			de.ls5.dywa.generated.rest.types.LMS cached = objectCache.getRestTo(source);
			
			if (cached == null) {
				cached = de.ls5.dywa.generated.rest.types.LMS.fromDywaEntity(source, objectCache);
			}
			
			if (!objectCache.containsSelective(cached, "LMSSelective")) {
				de.ls5.dywa.generated.rest.types.LMSSelective.copy(source, cached, objectCache);
			}
		
			effectiveTo.setlMS(cached);
		}
		}
		{
			final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser effectiveFrom = from;
