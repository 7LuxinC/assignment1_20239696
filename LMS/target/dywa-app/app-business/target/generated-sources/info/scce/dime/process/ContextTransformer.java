...
@Inject de.ls5.dywa.generated.controller.dime__HYPHEN_MINUS__models.app.LMSController LMSController;
@Inject de.ls5.dywa.generated.rest.controller.LMSREST LMSREST;
@Inject de.ls5.dywa.generated.controller.dime__HYPHEN_MINUS__models.app.LibrarianController LibrarianController;
@Inject de.ls5.dywa.generated.rest.controller.LibrarianREST LibrarianREST;
...
public de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS transform(de.ls5.dywa.generated.rest.types.LMS o) {
	final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.LMS obj;
	if (o.getDywaId() > 0) {
		obj = LMSController.read(o.getDywaId());
	}
	 else if (o instanceof de.ls5.dywa.generated.rest.types.LMS) {
		obj = LMSREST.copyToTransient((de.ls5.dywa.generated.rest.types.LMS) o);
	}
	 else { throw new java.lang.IllegalArgumentException("Unknown type"); } 
	return obj;
}
public de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Librarian transform(de.ls5.dywa.generated.rest.types.Librarian o) {
	final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Librarian obj;
	if (o.getDywaId() > 0) {
		obj = LibrarianController.read(o.getDywaId());
	}
	 else if (o instanceof de.ls5.dywa.generated.rest.types.Librarian) {
		obj = LibrarianREST.copyToTransient((de.ls5.dywa.generated.rest.types.Librarian) o);
	}
	 else { throw new java.lang.IllegalArgumentException("Unknown type"); } 
	return obj;
}
